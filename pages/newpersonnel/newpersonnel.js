// pages/newpersonnel/newpersonnel.js
...
Page({
  ...
  loadData: function (e) {
    ...
    util.requestPost(api.getJobwantedPage, data).then(
      res => {
        wx.hideLoading();
        console.log("2求职列表接口是否走成功了");
        console.log(res);
  ...
  // listpush: function(e) {
  //   wx.navigateTo({
  //     url: '../newpersonnelcon/newpersonnelcon',
  //   })
  // },
