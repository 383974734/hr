...
Page({
  ...
  data: {
    ...
    list: [],
    // list: [{
    //   img: "../../static/images/train-img.png",
    //   tit: "公文写作指南：如何成为令人尊重的笔杆子公文写作指南：如何成为令人尊重的笔杆子公文写作指南：如何成为令人尊重的笔杆子",
    //   name: "大姚老师",
    //   member: "会员免费",
    // },
    // {
    //   img: "../../static/images/train-img.png",
    //   tit: "公文写作指南：如何成为令人尊重的笔杆子",
    //   name: "大姚老师",
    //   member: "会员免费",
    // },
    // {
  ...
  loadData: function (e) {
    ...
    util.requestPost(api.getTtrainList, data, token).then(
      res => {
        wx.hideLoading();
