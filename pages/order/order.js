...
Page({
  ...
  loadData: function(e) {
    ...
    util.requestPost(api.getOrderList, data, token).then(
      res => {
  ...
  cellpush: function(e) {
    console.log(e);
    var jsonT = this.data.list[e.currentTarget.dataset.index];
    wx.navigateTo({
      url: '../ordercon/ordercon?json=' + JSON.stringify(jsonT),
    })
  }
})